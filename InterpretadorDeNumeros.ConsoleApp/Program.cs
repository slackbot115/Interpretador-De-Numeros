...
namespace InterpretadorDeNumeros.ConsoleApp
{
    ...
    {
        static string RemoveFirstLines(string text, int linesCount)
        {
        ...
        static void Main(string[] args)
        {
            ...
            // Deixar sempre um espaço do primeiro numero e entre cada numero
...
";
            ...
            while (true)
            {
                ...
                Console.WriteLine();
                if (sequencia_numeros.Length != 0)
                {
                    sequencia_numeros = RemoveFirstLines(sequencia_numeros, 4);
                    numeros_retornados += "\n";
                    continue;
                }
                else
